...
const DEFAULT_BANK = { number: '0000000000', owner: 'Khoyrul Yusuf Maulana' };
const DEFAULT_ADDRESS = 'Dusun Singkil, RT.02/RW.03, Desa Karanggondang, Kec. Pabelan, Kab. Semarang';
...
export const GiftSection: React.FC = () => {
  ...
  useEffect(() => {
    ...
    fetchGift('pria').then(apply);
    return subscribeGift('pria', apply);
  }, []);
